...
def extend_raw_details(raw_details):
    """Extend a details dict with some additional elements.
...
def user_details_raw():
    """Provide  default user details matching a parsed API response.
...
def user_admin_details_raw():
    """Provide default admin-user details matching a parsed API response.
...
def ppms_user(user_details):
    """Create a PpmsUser object with default values.
...
def ppms_user_admin(user_admin_details):
    """Create a PpmsUser object of an administrator user.

    Parameters
    ----------
    user_admin_details : dict
        A dictionary with user details.
...
def system_details_raw():
    """Provide default system details matching a parsed API response.
...
def fullname_mapping(ppms_user, ppms_user_admin):
    """Provide a dict to map user "fullnames" to login / account names."""
    mapping = {
...
def systemname_mapping(system_details_raw):
    """Provide a dict to map the system name to its ID."""
...
def runningsheet_response():
    """Provide an example response text of a 'getrunningsheet' request.
